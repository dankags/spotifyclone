...
import searchBarInputControllerReducer from "./slices/mainSearchBar";
import playlistPageMusicsReducer from './slices/playlistPageMusics'
...
export const makeStore = () => {
  return configureStore({
    reducer: {
      ...
      mainSearchBarInput: searchBarInputControllerReducer,
      playlistPageMusics:playlistPageMusicsReducer,
    },
  });
}
