...
function Login() {
  return (
    ...
    <div className='w-full py-8 pl-10 gap-3 flex items-center justify-start bg-neutral-950'>
    ...
    <div className='w-7/12 rounded-xl flex flex-col items-center justify-center py-14 bg-neutral-950 '>
    <h1 className='font-bold text-3xl py-4'>log in to Spotify</h1>
    <LogInProviders/>
