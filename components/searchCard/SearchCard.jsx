...
const SearchCard = ({ category, pageCurrentWidth }) => {
  ...
  return (
    <div className={` w-full min-h-24 relative rounded-md lg:rounded-lg overflow-hidden  p-3 text-white cursor-pointer   `} style={category?{backgroundColor:`${category.backgroundColor}`}:{backgroundColor:"rgb(255,255,255,0.6)"}}>
